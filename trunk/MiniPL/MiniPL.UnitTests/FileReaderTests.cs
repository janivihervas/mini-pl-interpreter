...
namespace MiniPL.UnitTests
{
    ...
    public class FileReaderTests
    {
        ...
        {
            Assert.Throws<Exceptions.IOException>(() => _fileReader.ReadFile(_fileName + ".mpl"));
        }
        ...
        {
            Assert.Throws<Exceptions.IOException>(() => _fileReader.ReadFile(_fileName + "test" + _fileExtension));
        }
